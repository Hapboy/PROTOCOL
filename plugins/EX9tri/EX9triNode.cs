...
namespace VVVV.Nodes
{
	...
	#region PluginInfo
	[PluginInfo(Name = "tri", Category = "EX9", Help = "Basic template which renders directly into the vvvv Renderer(EX9)", Tags = "")]
	#endregion PluginInfo
	public class EX9triNode : DXLayerOutPluginBase<CustomDeviceData>, IPluginEvaluate
	{
		#region fields & pins
		...
		public EX9triNode(IPluginHost host) : base(host, true, true)
		{
		}
